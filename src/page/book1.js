              ...
              <div class="container text-center">
                    <Card style={{width: '60rm'}}>
                      ...
                      <Row>
                        <Col>
                          <Card style={{width: '60rm'}}>
                             <Card.Img variant="top" src= 'https://www.womjapan.com/wp-content/uploads/2019/04/detective-novel-2-691x1024.jpg' />
                          </Card>
                        </Col>
                        <Col>
                            <Card.Title> Lone Castle in the Mirror </Card.Title>
                            <Card.Text> เป็นเรื่องราวแฟนตาซีของเด็กสาวไฮสคูลคนหนึ่งซึ่งหนีเรียนเข้าไปยังกระจกหนึ่งบาน และพบว่าภายในกระจกเต็มไปด้วยผู้คนที่เหมือนกับตัวเธอเอง เธอจึงร่วมมือกับผู้คนเหล่านั้นจนกระทั่งได้พัฒนาความสัมพันธ์จนสนิทชิดเชื้อ </Card.Text>
                            <Card.Text> <a class='text-muted'>Type : Japan </a></Card.Text>
                            <small class='text-muted'>ผู้เเต่ง : Mizuki Tsujimura (辻村深月) </small>
                            <hr/>
                            <Card.Link>
